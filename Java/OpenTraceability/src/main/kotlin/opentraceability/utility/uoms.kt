...
class UOMS {
    ...
    companion object {
        val _locker = Any()
        val uomsAbbrevDict = mutableMapOf<String, UOM>()
        val uomsUNCodeDict = mutableMapOf<String, UOM>()
        ...
        fun getUOMFromUNCode(name: String): UOM? {
            ...
            return uomsUNCodeDict[formattedName] ?: uomsAbbrevDict.values.find {
                it.UNCode.equals(
                    formattedName,
                    ignoreCase = true
                )
        ...
        val list: List<UOM>
            get() = synchronized(_locker) {
                return uomsAbbrevDict.values.toMutableList()
            }
    }
}
