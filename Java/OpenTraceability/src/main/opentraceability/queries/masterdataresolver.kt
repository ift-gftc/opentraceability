...
class MasterDataResolver<T> {
    ...
    fun ResolveTradingParty(options: DigitalLinkQueryOptions, pgln: PGLN, doc: EPCISBaseDocument, client: HttpClient) {
        TODO("Not yet implemented")
    }
    ...
    fun ResolveMasterDataItem(type: Type, options: DigitalLinkQueryOptions, relativeURL: String, httpClient: HttpClient): Object {
        TODO("Not yet implemented")
    }
}
