...
public class GDSTReceiveEvent extends ObjectEventBase<GDSTILMD> implements IGDSTEvent {
    ...
    public GDSTReceiveEvent()
    {
        this.businessStep = URI.create("urn:epcglobal:cbv:bizstep:receiving");
