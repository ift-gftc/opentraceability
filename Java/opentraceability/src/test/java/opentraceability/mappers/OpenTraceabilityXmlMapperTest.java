...
class OpenTraceabilityXmlMapperTest {
    ...
    void epcisDocument_to_from_xml() throws Exception
    {
        ...
        String[] files = new String[] {
                "object_event_all_possible_fields.xml",
                "aggregation_event_all_possible_fields.xml",
                "association_event_all_possible_fields.xml",
                "transformation_event_all_possible_fields.xml"
        };
